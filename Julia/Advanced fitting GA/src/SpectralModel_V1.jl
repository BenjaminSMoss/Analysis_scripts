...
#### INPUT
# create switching y values array - this sets regions in which the upper limit of 
#particular component spectra is set to zero
# see the get_upper_bound function definintion for logic of limit deteminination
upper_bound_switching_potentials=[1.3,1.7,2]
#lower_bound_switching_potentials=[1.4,1.76,2]
#lower_bound_values=[0.01,0.001,0.001]
...
Threads.@threads for ny in 1:length(y)
    ...
    currentZ = z[:,ny]
upper=get_upper_bound(ny,upper_bound_switching_potentials,y,pureZ)
#lower=get_lower_bound(ny,lower_bound_switching_potentials,y,pureZ,lower_bound_values)
