...
paramFixed = [
            [1, E_reg_1, (0,1)], # component 1, (y range), (lower and upper limit)
            [1, E_reg_2, (0,1)],
            [1, E_reg_3, (0.005,0.007)],
            [1, E_reg_4, (0.005,0.007)],

            [2, E_reg_1, (0,0)], # component 2, y range, (lower and upper limit)
            [2, E_reg_2, (0,1)],
            [2, E_reg_3, (0,1)],
            [2, E_reg_4, (0,1)],

            [3, E_reg_1, (0,0)], # component 3, y range, (lower and upper limit)
            [3, E_reg_2, (0,0)], 
            [3, E_reg_3, (0,0)],
            [3, E_reg_4, (0,1)],
            ] # 
...
#input the highest lower limit used here 
High_lower_start=0.05
...
dirData = raw"C:\Users\Benj\Box\Julia\GA2\data\Co\Data"
...
dirPureY =raw"C:\Users\Benj\Box\Julia\GA2\data\Co\Pure spectra\alt"
...
######THIS WAS PREVIOUSLY SET TO 1 NOT High_lower_start!#
startParam = fill(High_lower_start, size(pureZ,2))
...
kinPlot = plot(yOffset[yBool], paramOptNorm[yBool,:],xlabel="E (V vs RHE)", #xlim=(-1,1.5),
